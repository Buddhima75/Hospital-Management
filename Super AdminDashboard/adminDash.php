                    ...
                    <div class="col-sm-3">
                        <div class="well"><br>
                            <?php
                                ...
                                $result = $conn->query($sql1);
                                while($row = $result->fetch_assoc()) {
                                 echo "DOCTORS IN NAME  :  " . $row["full_name"]. "<br>";
                                }
                    ...
                    <div class="col-sm-4">
                        <div class="well">
                            <?php
                                ...
                                $sql1 = "SELECT full_name FROM staff where  job_role='doctor' and duty_shift='day' ";
                                $result = $conn->query($sql1);
                                while($row = $result->fetch_assoc()) {
                    ...
                    <div class="col-sm-4">
                        <div class="well">
                            <?php
                                ...
                                $sql1 = "SELECT full_name FROM staff where job_role='doctor' and duty_shift='night' ";
                                $result = $conn->query($sql1);
                                while($row = $result->fetch_assoc()) {
                                 echo "Name  : " . $row["full_name"]. "<br>";
                            }
