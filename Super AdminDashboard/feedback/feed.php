  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li ><a href="">Dashboard</a></li>
        ...
        <li ><a href="../Appointment/Appoint.php">Appointment</a></li>
...
if( isset( $_POST['search']))
 {
$search = $_POST["search"]; 
$sql = "SELECT * FROM `feedback` WHERE `email` LIKE '%".$search."%'  OR `number` LIKE '%".$search."%'";
...
?>
                    ...
                    <table>
                        ...
                        <tr>
                          ...
                          <td><a href="deletefeed.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger btn-sm" id="delete">Delete</a></td>
