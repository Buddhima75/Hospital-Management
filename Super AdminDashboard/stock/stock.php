...
?>
                    ...
                    <table>
                        ...
                        <a href="deleteStock.php?id=<?php echo $row["id"]; ?>" id="delete" class="btn btn-danger btn-sm">Delete</a></td>
                          </tr>
                          <?php
                          $i++;
                          }
                    ...
                    <?php
                      ...
                      ?>
<button class="btn btn-success ">  <a style="text-decoration:none; color:white;" href="addStock.html"> Add Stock Record</a>
