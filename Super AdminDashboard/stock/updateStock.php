...
header("Location: stock.php?insertion=pass&alert=" . urlencode($alert));
                ...
                <form  method="POST" action="" class="form-detail" id="myform">
                    ...
                    <div class="form-row">
                                ...
                                <div class="form-row-last">
                                    ...
                                    <a href="../../Super AdminDashboard\stock\stock.php"><input type="button" class="add_stock" name="submit" value="Back"></a>
