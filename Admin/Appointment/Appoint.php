  ...
  <body>
    ...
    ?>
      ...
      <table>
          ...
          <td>
        <br> <a href="deleteappo.php?id=<?php echo $row["id"]; ?>"class= "btn btn-danger btn-sm" id="delete" >Delete</a>
        <br><br> <a href="email.php?id=<?php echo $row["id"]; ?>"class= "btn btn-primary btn-sm" id="" >email</a></td>
