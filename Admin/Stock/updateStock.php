<?php 
 ...
 if(count($_POST)>0) {
    mysqli_query($conn,"UPDATE stock set id='" . $_POST['item_id'] . "', 
                        ...
                        // header("Location: ../../Admin/Stock/stock.php?insetion=pass");
                        $alert = "Update Stock Successfully";

                        header("Location: ../../Admin/Stock/stock.php?insertion=pass&alert=" . urlencode($alert));
 ...
 <html>
    ...
    <div class="form-row">
				...
				<div class="form-row-last">
                    ...
                    <a href="../../Admin\Stock\stock.php"><input type="button" class="add_stock" name="submit" value="Back"></a>
